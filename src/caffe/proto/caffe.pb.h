...
class PoseletKNNParameter;
class KNNPoolingParameter;
class FeatureKNNParameter;
...
enum PoseletKNNParameter_OutputMode {
  PoseletKNNParameter_OutputMode_OUTPUT_FEATURE = 0,
  PoseletKNNParameter_OutputMode_OUTPUT_SCORE = 1
};
bool PoseletKNNParameter_OutputMode_IsValid(int value);
const PoseletKNNParameter_OutputMode PoseletKNNParameter_OutputMode_OutputMode_MIN = PoseletKNNParameter_OutputMode_OUTPUT_FEATURE;
const PoseletKNNParameter_OutputMode PoseletKNNParameter_OutputMode_OutputMode_MAX = PoseletKNNParameter_OutputMode_OUTPUT_SCORE;
const int PoseletKNNParameter_OutputMode_OutputMode_ARRAYSIZE = PoseletKNNParameter_OutputMode_OutputMode_MAX + 1;

const ::google::protobuf::EnumDescriptor* PoseletKNNParameter_OutputMode_descriptor();
inline const ::std::string& PoseletKNNParameter_OutputMode_Name(PoseletKNNParameter_OutputMode value) {
  return ::google::protobuf::internal::NameOfEnum(
    PoseletKNNParameter_OutputMode_descriptor(), value);
}
inline bool PoseletKNNParameter_OutputMode_Parse(
    const ::std::string& name, PoseletKNNParameter_OutputMode* value) {
  return ::google::protobuf::internal::ParseNamedEnum<PoseletKNNParameter_OutputMode>(
    PoseletKNNParameter_OutputMode_descriptor(), name, value);
}
enum KNNPoolingParameter_KNNPoolMethod {
  KNNPoolingParameter_KNNPoolMethod_MAX = 0,
  KNNPoolingParameter_KNNPoolMethod_AVE = 1
};
bool KNNPoolingParameter_KNNPoolMethod_IsValid(int value);
const KNNPoolingParameter_KNNPoolMethod KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_MIN = KNNPoolingParameter_KNNPoolMethod_MAX;
const KNNPoolingParameter_KNNPoolMethod KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_MAX = KNNPoolingParameter_KNNPoolMethod_AVE;
const int KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_ARRAYSIZE = KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_MAX + 1;

const ::google::protobuf::EnumDescriptor* KNNPoolingParameter_KNNPoolMethod_descriptor();
inline const ::std::string& KNNPoolingParameter_KNNPoolMethod_Name(KNNPoolingParameter_KNNPoolMethod value) {
  return ::google::protobuf::internal::NameOfEnum(
    KNNPoolingParameter_KNNPoolMethod_descriptor(), value);
}
inline bool KNNPoolingParameter_KNNPoolMethod_Parse(
    const ::std::string& name, KNNPoolingParameter_KNNPoolMethod* value) {
  return ::google::protobuf::internal::ParseNamedEnum<KNNPoolingParameter_KNNPoolMethod>(
    KNNPoolingParameter_KNNPoolMethod_descriptor(), name, value);
}
enum KNNPoolingParameter_KNNPoolOrder {
  KNNPoolingParameter_KNNPoolOrder_SAMPLE_PRIORITY = 0,
  KNNPoolingParameter_KNNPoolOrder_K_PRIORITY = 1
};
bool KNNPoolingParameter_KNNPoolOrder_IsValid(int value);
const KNNPoolingParameter_KNNPoolOrder KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_MIN = KNNPoolingParameter_KNNPoolOrder_SAMPLE_PRIORITY;
const KNNPoolingParameter_KNNPoolOrder KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_MAX = KNNPoolingParameter_KNNPoolOrder_K_PRIORITY;
const int KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_ARRAYSIZE = KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_MAX + 1;

const ::google::protobuf::EnumDescriptor* KNNPoolingParameter_KNNPoolOrder_descriptor();
inline const ::std::string& KNNPoolingParameter_KNNPoolOrder_Name(KNNPoolingParameter_KNNPoolOrder value) {
  return ::google::protobuf::internal::NameOfEnum(
    KNNPoolingParameter_KNNPoolOrder_descriptor(), value);
}
inline bool KNNPoolingParameter_KNNPoolOrder_Parse(
    const ::std::string& name, KNNPoolingParameter_KNNPoolOrder* value) {
  return ::google::protobuf::internal::ParseNamedEnum<KNNPoolingParameter_KNNPoolOrder>(
    KNNPoolingParameter_KNNPoolOrder_descriptor(), name, value);
}
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.FeatureKNNParameter feature_knn_param = 138;
  inline bool has_feature_knn_param() const;
  inline void clear_feature_knn_param();
  static const int kFeatureKnnParamFieldNumber = 138;
  inline const ::caffe::FeatureKNNParameter& feature_knn_param() const;
  inline ::caffe::FeatureKNNParameter* mutable_feature_knn_param();
  inline ::caffe::FeatureKNNParameter* release_feature_knn_param();
  inline void set_allocated_feature_knn_param(::caffe::FeatureKNNParameter* feature_knn_param);

  // optional .caffe.KNNPoolingParameter knn_pooling_param = 139;
  inline bool has_knn_pooling_param() const;
  inline void clear_knn_pooling_param();
  static const int kKnnPoolingParamFieldNumber = 139;
  inline const ::caffe::KNNPoolingParameter& knn_pooling_param() const;
  inline ::caffe::KNNPoolingParameter* mutable_knn_pooling_param();
  inline ::caffe::KNNPoolingParameter* release_knn_pooling_param();
  inline void set_allocated_knn_pooling_param(::caffe::KNNPoolingParameter* knn_pooling_param);

  // optional .caffe.PoseletKNNParameter poselet_knn_param = 140;
  inline bool has_poselet_knn_param() const;
  inline void clear_poselet_knn_param();
  static const int kPoseletKnnParamFieldNumber = 140;
  inline const ::caffe::PoseletKNNParameter& poselet_knn_param() const;
  inline ::caffe::PoseletKNNParameter* mutable_poselet_knn_param();
  inline ::caffe::PoseletKNNParameter* release_poselet_knn_param();
  inline void set_allocated_poselet_knn_param(::caffe::PoseletKNNParameter* poselet_knn_param);
 ...
 private:
  ...
  inline void set_has_feature_knn_param();
  inline void clear_has_feature_knn_param();
  inline void set_has_knn_pooling_param();
  inline void clear_has_knn_pooling_param();
  inline void set_has_poselet_knn_param();
  inline void clear_has_poselet_knn_param();
  ...
  ::caffe::FeatureKNNParameter* feature_knn_param_;
  ::caffe::KNNPoolingParameter* knn_pooling_param_;
  ::caffe::PoseletKNNParameter* poselet_knn_param_;
  int phase_;
...
class PoseletKNNParameter : public ::google::protobuf::Message {
 public:
  PoseletKNNParameter();
  virtual ~PoseletKNNParameter();

  PoseletKNNParameter(const PoseletKNNParameter& from);

  inline PoseletKNNParameter& operator=(const PoseletKNNParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const PoseletKNNParameter& default_instance();

  void Swap(PoseletKNNParameter* other);

  // implements Message ----------------------------------------------

  PoseletKNNParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const PoseletKNNParameter& from);
  void MergeFrom(const PoseletKNNParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef PoseletKNNParameter_OutputMode OutputMode;
  static const OutputMode OUTPUT_FEATURE = PoseletKNNParameter_OutputMode_OUTPUT_FEATURE;
  static const OutputMode OUTPUT_SCORE = PoseletKNNParameter_OutputMode_OUTPUT_SCORE;
  static inline bool OutputMode_IsValid(int value) {
    return PoseletKNNParameter_OutputMode_IsValid(value);
  }
  static const OutputMode OutputMode_MIN =
    PoseletKNNParameter_OutputMode_OutputMode_MIN;
  static const OutputMode OutputMode_MAX =
    PoseletKNNParameter_OutputMode_OutputMode_MAX;
  static const int OutputMode_ARRAYSIZE =
    PoseletKNNParameter_OutputMode_OutputMode_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  OutputMode_descriptor() {
    return PoseletKNNParameter_OutputMode_descriptor();
  }
  static inline const ::std::string& OutputMode_Name(OutputMode value) {
    return PoseletKNNParameter_OutputMode_Name(value);
  }
  static inline bool OutputMode_Parse(const ::std::string& name,
      OutputMode* value) {
    return PoseletKNNParameter_OutputMode_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional uint32 k_neighbor_num = 1 [default = 1];
  inline bool has_k_neighbor_num() const;
  inline void clear_k_neighbor_num();
  static const int kKNeighborNumFieldNumber = 1;
  inline ::google::protobuf::uint32 k_neighbor_num() const;
  inline void set_k_neighbor_num(::google::protobuf::uint32 value);

  // optional float knn_threshold = 2 [default = 0];
  inline bool has_knn_threshold() const;
  inline void clear_knn_threshold();
  static const int kKnnThresholdFieldNumber = 2;
  inline float knn_threshold() const;
  inline void set_knn_threshold(float value);

  // optional bool show_debug_info = 3 [default = false];
  inline bool has_show_debug_info() const;
  inline void clear_show_debug_info();
  static const int kShowDebugInfoFieldNumber = 3;
  inline bool show_debug_info() const;
  inline void set_show_debug_info(bool value);
  ...
  // optional .caffe.PoseletKNNParameter.OutputMode output_mode = 5 [default = OUTPUT_FEATURE];
  inline bool has_output_mode() const;
  inline void clear_output_mode();
  static const int kOutputModeFieldNumber = 5;
  inline ::caffe::PoseletKNNParameter_OutputMode output_mode() const;
  inline void set_output_mode(::caffe::PoseletKNNParameter_OutputMode value);

  // optional uint32 poselet_num_per_person = 6 [default = 1];
  inline bool has_poselet_num_per_person() const;
  inline void clear_poselet_num_per_person();
  static const int kPoseletNumPerPersonFieldNumber = 6;
  inline ::google::protobuf::uint32 poselet_num_per_person() const;
  inline void set_poselet_num_per_person(::google::protobuf::uint32 value);

  // optional bool poselet_weight = 7 [default = false];
  inline bool has_poselet_weight() const;
  inline void clear_poselet_weight();
  static const int kPoseletWeightFieldNumber = 7;
  inline bool poselet_weight() const;
  inline void set_poselet_weight(bool value);

  // optional uint32 num_select_poselet = 8 [default = 0];
  inline bool has_num_select_poselet() const;
  inline void clear_num_select_poselet();
  static const int kNumSelectPoseletFieldNumber = 8;
  inline ::google::protobuf::uint32 num_select_poselet() const;
  inline void set_num_select_poselet(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.PoseletKNNParameter)
 private:
  inline void set_has_k_neighbor_num();
  inline void clear_has_k_neighbor_num();
  inline void set_has_knn_threshold();
  inline void clear_has_knn_threshold();
  inline void set_has_show_debug_info();
  inline void clear_has_show_debug_info();
  inline void set_has_debug_info();
  inline void clear_has_debug_info();
  inline void set_has_output_mode();
  inline void clear_has_output_mode();
  inline void set_has_poselet_num_per_person();
  inline void clear_has_poselet_num_per_person();
  inline void set_has_poselet_weight();
  inline void clear_has_poselet_weight();
  inline void set_has_num_select_poselet();
  inline void clear_has_num_select_poselet();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::google::protobuf::uint32 k_neighbor_num_;
  float knn_threshold_;
  ::std::string* debug_info_;
  int output_mode_;
  bool show_debug_info_;
  bool poselet_weight_;
  ::google::protobuf::uint32 poselet_num_per_person_;
  ::google::protobuf::uint32 num_select_poselet_;
  ...
  void InitAsDefaultInstance();
  static PoseletKNNParameter* default_instance_;
};
// -------------------------------------------------------------------

class KNNPoolingParameter : public ::google::protobuf::Message {
 public:
  KNNPoolingParameter();
  virtual ~KNNPoolingParameter();

  KNNPoolingParameter(const KNNPoolingParameter& from);

  inline KNNPoolingParameter& operator=(const KNNPoolingParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const KNNPoolingParameter& default_instance();

  void Swap(KNNPoolingParameter* other);

  // implements Message ----------------------------------------------

  KNNPoolingParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const KNNPoolingParameter& from);
  void MergeFrom(const KNNPoolingParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  typedef KNNPoolingParameter_KNNPoolMethod KNNPoolMethod;
  static const KNNPoolMethod MAX = KNNPoolingParameter_KNNPoolMethod_MAX;
  static const KNNPoolMethod AVE = KNNPoolingParameter_KNNPoolMethod_AVE;
  static inline bool KNNPoolMethod_IsValid(int value) {
    return KNNPoolingParameter_KNNPoolMethod_IsValid(value);
  }
  static const KNNPoolMethod KNNPoolMethod_MIN =
    KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_MIN;
  static const KNNPoolMethod KNNPoolMethod_MAX =
    KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_MAX;
  static const int KNNPoolMethod_ARRAYSIZE =
    KNNPoolingParameter_KNNPoolMethod_KNNPoolMethod_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  KNNPoolMethod_descriptor() {
    return KNNPoolingParameter_KNNPoolMethod_descriptor();
  }
  static inline const ::std::string& KNNPoolMethod_Name(KNNPoolMethod value) {
    return KNNPoolingParameter_KNNPoolMethod_Name(value);
  }
  static inline bool KNNPoolMethod_Parse(const ::std::string& name,
      KNNPoolMethod* value) {
    return KNNPoolingParameter_KNNPoolMethod_Parse(name, value);
  }

  typedef KNNPoolingParameter_KNNPoolOrder KNNPoolOrder;
  static const KNNPoolOrder SAMPLE_PRIORITY = KNNPoolingParameter_KNNPoolOrder_SAMPLE_PRIORITY;
  static const KNNPoolOrder K_PRIORITY = KNNPoolingParameter_KNNPoolOrder_K_PRIORITY;
  static inline bool KNNPoolOrder_IsValid(int value) {
    return KNNPoolingParameter_KNNPoolOrder_IsValid(value);
  }
  static const KNNPoolOrder KNNPoolOrder_MIN =
    KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_MIN;
  static const KNNPoolOrder KNNPoolOrder_MAX =
    KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_MAX;
  static const int KNNPoolOrder_ARRAYSIZE =
    KNNPoolingParameter_KNNPoolOrder_KNNPoolOrder_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  KNNPoolOrder_descriptor() {
    return KNNPoolingParameter_KNNPoolOrder_descriptor();
  }
  static inline const ::std::string& KNNPoolOrder_Name(KNNPoolOrder value) {
    return KNNPoolingParameter_KNNPoolOrder_Name(value);
  }
  static inline bool KNNPoolOrder_Parse(const ::std::string& name,
      KNNPoolOrder* value) {
    return KNNPoolingParameter_KNNPoolOrder_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.KNNPoolingParameter.KNNPoolMethod pool_method = 1 [default = MAX];
  inline bool has_pool_method() const;
  inline void clear_pool_method();
  static const int kPoolMethodFieldNumber = 1;
  inline ::caffe::KNNPoolingParameter_KNNPoolMethod pool_method() const;
  inline void set_pool_method(::caffe::KNNPoolingParameter_KNNPoolMethod value);

  // optional uint32 k_neighbor_num = 2 [default = 1];
  inline bool has_k_neighbor_num() const;
  inline void clear_k_neighbor_num();
  static const int kKNeighborNumFieldNumber = 2;
  inline ::google::protobuf::uint32 k_neighbor_num() const;
  inline void set_k_neighbor_num(::google::protobuf::uint32 value);

  // optional .caffe.KNNPoolingParameter.KNNPoolOrder pool_order = 3 [default = SAMPLE_PRIORITY];
  inline bool has_pool_order() const;
  inline void clear_pool_order();
  static const int kPoolOrderFieldNumber = 3;
  inline ::caffe::KNNPoolingParameter_KNNPoolOrder pool_order() const;
  inline void set_pool_order(::caffe::KNNPoolingParameter_KNNPoolOrder value);

  // optional bool show_debug_info = 4 [default = false];
  inline bool has_show_debug_info() const;
  inline void clear_show_debug_info();
  static const int kShowDebugInfoFieldNumber = 4;
  inline bool show_debug_info() const;
  inline void set_show_debug_info(bool value);

  // @@protoc_insertion_point(class_scope:caffe.KNNPoolingParameter)
 private:
  inline void set_has_pool_method();
  inline void clear_has_pool_method();
  inline void set_has_k_neighbor_num();
  inline void clear_has_k_neighbor_num();
  inline void set_has_pool_order();
  inline void clear_has_pool_order();
  inline void set_has_show_debug_info();
  inline void clear_has_show_debug_info();
  ...
  void InitAsDefaultInstance();
  static KNNPoolingParameter* default_instance_;
};
// -------------------------------------------------------------------

class FeatureKNNParameter : public ::google::protobuf::Message {
 public:
  FeatureKNNParameter();
  virtual ~FeatureKNNParameter();

  FeatureKNNParameter(const FeatureKNNParameter& from);

  inline FeatureKNNParameter& operator=(const FeatureKNNParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const FeatureKNNParameter& default_instance();

  void Swap(FeatureKNNParameter* other);

  // implements Message ----------------------------------------------

  FeatureKNNParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const FeatureKNNParameter& from);
  void MergeFrom(const FeatureKNNParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.FeatureKNNParameter)
 private:
  inline void set_has_k_neighbor_num();
  inline void clear_has_k_neighbor_num();
  inline void set_has_knn_threshold();
  ...
  void InitAsDefaultInstance();
  static FeatureKNNParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.FeatureKNNParameter feature_knn_param = 138;
inline bool LayerParameter::has_feature_knn_param() const {
  return (_has_bits_[1] & 0x00020000u) != 0;
}
inline void LayerParameter::set_has_feature_knn_param() {
  _has_bits_[1] |= 0x00020000u;
}
inline void LayerParameter::clear_has_feature_knn_param() {
  _has_bits_[1] &= ~0x00020000u;
}
inline void LayerParameter::clear_feature_knn_param() {
  if (feature_knn_param_ != NULL) feature_knn_param_->::caffe::FeatureKNNParameter::Clear();
  clear_has_feature_knn_param();
}
inline const ::caffe::FeatureKNNParameter& LayerParameter::feature_knn_param() const {
  return feature_knn_param_ != NULL ? *feature_knn_param_ : *default_instance_->feature_knn_param_;
}
inline ::caffe::FeatureKNNParameter* LayerParameter::mutable_feature_knn_param() {
  set_has_feature_knn_param();
  if (feature_knn_param_ == NULL) feature_knn_param_ = new ::caffe::FeatureKNNParameter;
  return feature_knn_param_;
}
inline ::caffe::FeatureKNNParameter* LayerParameter::release_feature_knn_param() {
  clear_has_feature_knn_param();
  ::caffe::FeatureKNNParameter* temp = feature_knn_param_;
  feature_knn_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_feature_knn_param(::caffe::FeatureKNNParameter* feature_knn_param) {
  delete feature_knn_param_;
  feature_knn_param_ = feature_knn_param;
  if (feature_knn_param) {
    set_has_feature_knn_param();
  } else {
    clear_has_feature_knn_param();
  }
...
// optional .caffe.KNNPoolingParameter knn_pooling_param = 139;
inline bool LayerParameter::has_knn_pooling_param() const {
  return (_has_bits_[1] & 0x00040000u) != 0;
}
inline void LayerParameter::set_has_knn_pooling_param() {
  _has_bits_[1] |= 0x00040000u;
}
inline void LayerParameter::clear_has_knn_pooling_param() {
  _has_bits_[1] &= ~0x00040000u;
}
inline void LayerParameter::clear_knn_pooling_param() {
  if (knn_pooling_param_ != NULL) knn_pooling_param_->::caffe::KNNPoolingParameter::Clear();
  clear_has_knn_pooling_param();
}
inline const ::caffe::KNNPoolingParameter& LayerParameter::knn_pooling_param() const {
  return knn_pooling_param_ != NULL ? *knn_pooling_param_ : *default_instance_->knn_pooling_param_;
}
inline ::caffe::KNNPoolingParameter* LayerParameter::mutable_knn_pooling_param() {
  set_has_knn_pooling_param();
  if (knn_pooling_param_ == NULL) knn_pooling_param_ = new ::caffe::KNNPoolingParameter;
  return knn_pooling_param_;
}
inline ::caffe::KNNPoolingParameter* LayerParameter::release_knn_pooling_param() {
  clear_has_knn_pooling_param();
  ::caffe::KNNPoolingParameter* temp = knn_pooling_param_;
  knn_pooling_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_knn_pooling_param(::caffe::KNNPoolingParameter* knn_pooling_param) {
  delete knn_pooling_param_;
  knn_pooling_param_ = knn_pooling_param;
  if (knn_pooling_param) {
    set_has_knn_pooling_param();
  } else {
    clear_has_knn_pooling_param();
  }
...
// optional .caffe.PoseletKNNParameter poselet_knn_param = 140;
inline bool LayerParameter::has_poselet_knn_param() const {
  return (_has_bits_[1] & 0x00080000u) != 0;
}
inline void LayerParameter::set_has_poselet_knn_param() {
  _has_bits_[1] |= 0x00080000u;
}
inline void LayerParameter::clear_has_poselet_knn_param() {
  _has_bits_[1] &= ~0x00080000u;
}
inline void LayerParameter::clear_poselet_knn_param() {
  if (poselet_knn_param_ != NULL) poselet_knn_param_->::caffe::PoseletKNNParameter::Clear();
  clear_has_poselet_knn_param();
}
inline const ::caffe::PoseletKNNParameter& LayerParameter::poselet_knn_param() const {
  return poselet_knn_param_ != NULL ? *poselet_knn_param_ : *default_instance_->poselet_knn_param_;
}
inline ::caffe::PoseletKNNParameter* LayerParameter::mutable_poselet_knn_param() {
  set_has_poselet_knn_param();
  if (poselet_knn_param_ == NULL) poselet_knn_param_ = new ::caffe::PoseletKNNParameter;
  return poselet_knn_param_;
}
inline ::caffe::PoseletKNNParameter* LayerParameter::release_poselet_knn_param() {
  clear_has_poselet_knn_param();
  ::caffe::PoseletKNNParameter* temp = poselet_knn_param_;
  poselet_knn_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_poselet_knn_param(::caffe::PoseletKNNParameter* poselet_knn_param) {
  delete poselet_knn_param_;
  poselet_knn_param_ = poselet_knn_param;
  if (poselet_knn_param) {
    set_has_poselet_knn_param();
  } else {
    clear_has_poselet_knn_param();
  }
...
// optional uint32 k_neighbor_num = 1 [default = 1];
inline bool PoseletKNNParameter::has_k_neighbor_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void PoseletKNNParameter::set_has_k_neighbor_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void PoseletKNNParameter::clear_has_k_neighbor_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void PoseletKNNParameter::clear_k_neighbor_num() {
  k_neighbor_num_ = 1u;
  clear_has_k_neighbor_num();
}
inline ::google::protobuf::uint32 PoseletKNNParameter::k_neighbor_num() const {
  return k_neighbor_num_;
}
inline void PoseletKNNParameter::set_k_neighbor_num(::google::protobuf::uint32 value) {
  set_has_k_neighbor_num();
  k_neighbor_num_ = value;
}

// optional float knn_threshold = 2 [default = 0];
inline bool PoseletKNNParameter::has_knn_threshold() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void PoseletKNNParameter::set_has_knn_threshold() {
  _has_bits_[0] |= 0x00000002u;
}
inline void PoseletKNNParameter::clear_has_knn_threshold() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void PoseletKNNParameter::clear_knn_threshold() {
  knn_threshold_ = 0;
  clear_has_knn_threshold();
}
inline float PoseletKNNParameter::knn_threshold() const {
  return knn_threshold_;
}
inline void PoseletKNNParameter::set_knn_threshold(float value) {
  set_has_knn_threshold();
  knn_threshold_ = value;
}

// optional bool show_debug_info = 3 [default = false];
inline bool PoseletKNNParameter::has_show_debug_info() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void PoseletKNNParameter::set_has_show_debug_info() {
  _has_bits_[0] |= 0x00000004u;
}
inline void PoseletKNNParameter::clear_has_show_debug_info() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void PoseletKNNParameter::clear_show_debug_info() {
  show_debug_info_ = false;
  clear_has_show_debug_info();
}
inline bool PoseletKNNParameter::show_debug_info() const {
  return show_debug_info_;
}
inline void PoseletKNNParameter::set_show_debug_info(bool value) {
  set_has_show_debug_info();
  show_debug_info_ = value;
}

// optional string debug_info = 4;
inline bool PoseletKNNParameter::has_debug_info() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void PoseletKNNParameter::set_has_debug_info() {
  _has_bits_[0] |= 0x00000008u;
}
inline void PoseletKNNParameter::clear_has_debug_info() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void PoseletKNNParameter::clear_debug_info() {
  if (debug_info_ != &::google::protobuf::internal::kEmptyString) {
    debug_info_->clear();
  }
  clear_has_debug_info();
}
inline const ::std::string& PoseletKNNParameter::debug_info() const {
  return *debug_info_;
}
inline void PoseletKNNParameter::set_debug_info(const ::std::string& value) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
...
inline void PoseletKNNParameter::set_debug_info(const char* value) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline void PoseletKNNParameter::set_debug_info(const char* value, size_t size) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline ::std::string* PoseletKNNParameter::mutable_debug_info() {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline ::std::string* PoseletKNNParameter::release_debug_info() {
  clear_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void PoseletKNNParameter::set_allocated_debug_info(::std::string* debug_info) {
  if (debug_info_ != &::google::protobuf::internal::kEmptyString) {
    delete debug_info_;
  }
  if (debug_info) {
...
// optional .caffe.PoseletKNNParameter.OutputMode output_mode = 5 [default = OUTPUT_FEATURE];
inline bool PoseletKNNParameter::has_output_mode() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void PoseletKNNParameter::set_has_output_mode() {
  _has_bits_[0] |= 0x00000010u;
}
inline void PoseletKNNParameter::clear_has_output_mode() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void PoseletKNNParameter::clear_output_mode() {
  output_mode_ = 0;
  clear_has_output_mode();
}
inline ::caffe::PoseletKNNParameter_OutputMode PoseletKNNParameter::output_mode() const {
  return static_cast< ::caffe::PoseletKNNParameter_OutputMode >(output_mode_);
}
inline void PoseletKNNParameter::set_output_mode(::caffe::PoseletKNNParameter_OutputMode value) {
  assert(::caffe::PoseletKNNParameter_OutputMode_IsValid(value));
  set_has_output_mode();
  output_mode_ = value;
}

// optional uint32 poselet_num_per_person = 6 [default = 1];
inline bool PoseletKNNParameter::has_poselet_num_per_person() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void PoseletKNNParameter::set_has_poselet_num_per_person() {
  _has_bits_[0] |= 0x00000020u;
}
inline void PoseletKNNParameter::clear_has_poselet_num_per_person() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void PoseletKNNParameter::clear_poselet_num_per_person() {
  poselet_num_per_person_ = 1u;
  clear_has_poselet_num_per_person();
}
inline ::google::protobuf::uint32 PoseletKNNParameter::poselet_num_per_person() const {
  return poselet_num_per_person_;
}
inline void PoseletKNNParameter::set_poselet_num_per_person(::google::protobuf::uint32 value) {
  set_has_poselet_num_per_person();
  poselet_num_per_person_ = value;
}

// optional bool poselet_weight = 7 [default = false];
inline bool PoseletKNNParameter::has_poselet_weight() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void PoseletKNNParameter::set_has_poselet_weight() {
  _has_bits_[0] |= 0x00000040u;
}
inline void PoseletKNNParameter::clear_has_poselet_weight() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void PoseletKNNParameter::clear_poselet_weight() {
  poselet_weight_ = false;
  clear_has_poselet_weight();
}
inline bool PoseletKNNParameter::poselet_weight() const {
  return poselet_weight_;
}
inline void PoseletKNNParameter::set_poselet_weight(bool value) {
  set_has_poselet_weight();
  poselet_weight_ = value;
}

// optional uint32 num_select_poselet = 8 [default = 0];
inline bool PoseletKNNParameter::has_num_select_poselet() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void PoseletKNNParameter::set_has_num_select_poselet() {
  _has_bits_[0] |= 0x00000080u;
}
inline void PoseletKNNParameter::clear_has_num_select_poselet() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void PoseletKNNParameter::clear_num_select_poselet() {
  num_select_poselet_ = 0u;
  clear_has_num_select_poselet();
}
inline ::google::protobuf::uint32 PoseletKNNParameter::num_select_poselet() const {
  return num_select_poselet_;
}
inline void PoseletKNNParameter::set_num_select_poselet(::google::protobuf::uint32 value) {
  set_has_num_select_poselet();
  num_select_poselet_ = value;
}
...
// optional .caffe.KNNPoolingParameter.KNNPoolMethod pool_method = 1 [default = MAX];
inline bool KNNPoolingParameter::has_pool_method() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void KNNPoolingParameter::set_has_pool_method() {
  _has_bits_[0] |= 0x00000001u;
}
inline void KNNPoolingParameter::clear_has_pool_method() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void KNNPoolingParameter::clear_pool_method() {
  pool_method_ = 0;
  clear_has_pool_method();
}
inline ::caffe::KNNPoolingParameter_KNNPoolMethod KNNPoolingParameter::pool_method() const {
  return static_cast< ::caffe::KNNPoolingParameter_KNNPoolMethod >(pool_method_);
}
inline void KNNPoolingParameter::set_pool_method(::caffe::KNNPoolingParameter_KNNPoolMethod value) {
  assert(::caffe::KNNPoolingParameter_KNNPoolMethod_IsValid(value));
  set_has_pool_method();
  pool_method_ = value;
}

// optional uint32 k_neighbor_num = 2 [default = 1];
inline bool KNNPoolingParameter::has_k_neighbor_num() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void KNNPoolingParameter::set_has_k_neighbor_num() {
  _has_bits_[0] |= 0x00000002u;
}
inline void KNNPoolingParameter::clear_has_k_neighbor_num() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void KNNPoolingParameter::clear_k_neighbor_num() {
  k_neighbor_num_ = 1u;
  clear_has_k_neighbor_num();
}
inline ::google::protobuf::uint32 KNNPoolingParameter::k_neighbor_num() const {
  return k_neighbor_num_;
}
inline void KNNPoolingParameter::set_k_neighbor_num(::google::protobuf::uint32 value) {
  set_has_k_neighbor_num();
  k_neighbor_num_ = value;
}

// optional .caffe.KNNPoolingParameter.KNNPoolOrder pool_order = 3 [default = SAMPLE_PRIORITY];
inline bool KNNPoolingParameter::has_pool_order() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void KNNPoolingParameter::set_has_pool_order() {
  _has_bits_[0] |= 0x00000004u;
}
inline void KNNPoolingParameter::clear_has_pool_order() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void KNNPoolingParameter::clear_pool_order() {
  pool_order_ = 0;
  clear_has_pool_order();
}
inline ::caffe::KNNPoolingParameter_KNNPoolOrder KNNPoolingParameter::pool_order() const {
  return static_cast< ::caffe::KNNPoolingParameter_KNNPoolOrder >(pool_order_);
}
inline void KNNPoolingParameter::set_pool_order(::caffe::KNNPoolingParameter_KNNPoolOrder value) {
  assert(::caffe::KNNPoolingParameter_KNNPoolOrder_IsValid(value));
  set_has_pool_order();
  pool_order_ = value;
}

// optional bool show_debug_info = 4 [default = false];
inline bool KNNPoolingParameter::has_show_debug_info() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void KNNPoolingParameter::set_has_show_debug_info() {
  _has_bits_[0] |= 0x00000008u;
}
inline void KNNPoolingParameter::clear_has_show_debug_info() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void KNNPoolingParameter::clear_show_debug_info() {
  show_debug_info_ = false;
  clear_has_show_debug_info();
}
inline bool KNNPoolingParameter::show_debug_info() const {
  return show_debug_info_;
}
inline void KNNPoolingParameter::set_show_debug_info(bool value) {
  set_has_show_debug_info();
  show_debug_info_ = value;
}
...
// optional uint32 k_neighbor_num = 1 [default = 1];
inline bool FeatureKNNParameter::has_k_neighbor_num() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void FeatureKNNParameter::set_has_k_neighbor_num() {
  _has_bits_[0] |= 0x00000001u;
}
inline void FeatureKNNParameter::clear_has_k_neighbor_num() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void FeatureKNNParameter::clear_k_neighbor_num() {
  k_neighbor_num_ = 1u;
  clear_has_k_neighbor_num();
}
inline ::google::protobuf::uint32 FeatureKNNParameter::k_neighbor_num() const {
  return k_neighbor_num_;
}
inline void FeatureKNNParameter::set_k_neighbor_num(::google::protobuf::uint32 value) {
  set_has_k_neighbor_num();
  k_neighbor_num_ = value;
}

// optional float knn_threshold = 2 [default = 0];
inline bool FeatureKNNParameter::has_knn_threshold() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void FeatureKNNParameter::set_has_knn_threshold() {
  _has_bits_[0] |= 0x00000002u;
}
inline void FeatureKNNParameter::clear_has_knn_threshold() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void FeatureKNNParameter::clear_knn_threshold() {
  knn_threshold_ = 0;
  clear_has_knn_threshold();
}
inline float FeatureKNNParameter::knn_threshold() const {
  return knn_threshold_;
}
inline void FeatureKNNParameter::set_knn_threshold(float value) {
  set_has_knn_threshold();
  knn_threshold_ = value;
}

// optional bool show_debug_info = 3 [default = false];
inline bool FeatureKNNParameter::has_show_debug_info() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void FeatureKNNParameter::set_has_show_debug_info() {
  _has_bits_[0] |= 0x00000004u;
}
inline void FeatureKNNParameter::clear_has_show_debug_info() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void FeatureKNNParameter::clear_show_debug_info() {
  show_debug_info_ = false;
  clear_has_show_debug_info();
}
inline bool FeatureKNNParameter::show_debug_info() const {
  return show_debug_info_;
}
inline void FeatureKNNParameter::set_show_debug_info(bool value) {
  set_has_show_debug_info();
  show_debug_info_ = value;
}

// optional string debug_info = 4;
inline bool FeatureKNNParameter::has_debug_info() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void FeatureKNNParameter::set_has_debug_info() {
  _has_bits_[0] |= 0x00000008u;
}
inline void FeatureKNNParameter::clear_has_debug_info() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void FeatureKNNParameter::clear_debug_info() {
  if (debug_info_ != &::google::protobuf::internal::kEmptyString) {
    debug_info_->clear();
  }
  clear_has_debug_info();
}
inline const ::std::string& FeatureKNNParameter::debug_info() const {
  return *debug_info_;
}
inline void FeatureKNNParameter::set_debug_info(const ::std::string& value) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline void FeatureKNNParameter::set_debug_info(const char* value) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline void FeatureKNNParameter::set_debug_info(const char* value, size_t size) {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline ::std::string* FeatureKNNParameter::mutable_debug_info() {
  set_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    debug_info_ = new ::std::string;
  }
...
inline ::std::string* FeatureKNNParameter::release_debug_info() {
  clear_has_debug_info();
  if (debug_info_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void FeatureKNNParameter::set_allocated_debug_info(::std::string* debug_info) {
  if (debug_info_ != &::google::protobuf::internal::kEmptyString) {
    delete debug_info_;
  }
  if (debug_info) {
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::PoseletKNNParameter_OutputMode>() {
  return ::caffe::PoseletKNNParameter_OutputMode_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::KNNPoolingParameter_KNNPoolMethod>() {
  return ::caffe::KNNPoolingParameter_KNNPoolMethod_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::KNNPoolingParameter_KNNPoolOrder>() {
  return ::caffe::KNNPoolingParameter_KNNPoolOrder_descriptor();
}
template <>
